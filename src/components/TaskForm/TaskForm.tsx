...
const ModalAgregarTarea: React.FC<ModalAgregarTareaProps> = ({ showModal, handleClose, createTask }) => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            descripcion: '',
            tiempo: 0,
            imagen: 'https://cdn-images.welcometothejungle.com/1hw3AIeaOzS_xueitADSAOXROowSS0MH_ezjJRO7cJM/rs:auto:980::/q:85/czM6Ly93dHRqLXByb2R1Y3Rpb24vdXBsb2Fkcy9hcnRpY2xlL2ltYWdlLzE0NTUvMTU4NDYxL2xpc3RhLXRhcmVhcy5qcGc',
            responsable: '',
            estado: '',
        },
        ...
        onSubmit: async (values, onsubmitPorps) => {
